...
async function convertFramesToWebm(jobId: string, framesDir: string, webmPath: string): Promise<void> {
  try {
...
async function convertToHLS(jobId: string, webmPath: string): Promise<{ m3u8Path?: string; tsPaths?: string[] }> {
  try {
